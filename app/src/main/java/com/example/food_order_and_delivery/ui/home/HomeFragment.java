...
public class HomeFragment extends Fragment {
    ...
    private int[] mImageIds = new int[] {R.drawable.ic_launcher_background, R.drawable.ic_launcher_background, R.drawable.ic_launcher_background, R.drawable.ic_launcher_background};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        restlist.add(new Restaurants("Momotaro", "Thamel","98038383938", R.drawable.ic_launcher_background));
        restlist.add(new Restaurants("Bajekosekuwa", "Sinamangal","327209375", R.drawable.ic_launcher_background));
        restlist.add(new Restaurants("Burgers point", "Dillibazar","6757587548648", R.drawable.ic_launcher_background));
        restlist.add(new Restaurants("pizza Hut", "Durbarmarg","848488483939", R.drawable.ic_launcher_background));
